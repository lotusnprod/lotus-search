...
class TestDataModel:
    ...
    def test_num(self):
        ...
        assert self.dm.num_couples() == 3, f"Expected couples, got {self.dm.num_couples()}"
        assert self.dm.num_structures() == 4, f"Expected structures, got {self.dm.num_structures()}"
