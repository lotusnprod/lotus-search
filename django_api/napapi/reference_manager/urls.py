...
from .views import ReferenceCreate, ReferenceDelete, ReferenceDetail, ReferenceDetailWid, ReferenceList, \
    ReferenceUpdate
...
urlpatterns = [
    ...
    path('wid/<int:wid>/', ReferenceDetailWid.as_view(), name='retrieve-reference-by-wid'),
